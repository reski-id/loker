...
<div class="col-md-6">
  ...
  <table class="table table-bordered table-striped table-hover" width="100%">
    ...
    <a href="perusahaan/v" class="btn btn-default" title="Kembali"><i class="fa fa-angle-double-left"></i> </a>
    <a href="perusahaan/v/e/<?php echo hashids_encrypt($query['id_user']); ?>" class="btn btn-success" style="float:right" title="Edit"><i class="fa fa-pencil"></i> </a>
